 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.bdd.bddDsl.impl.ListValueImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListValueImpl extends PropertyValueImpl implements ListValue
{
  /**
  ...
  {
    return BddDslPackage.Literals.LIST_VALUE;
  }
  ...
  public EList<SimpleValue> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<SimpleValue>(SimpleValue.class, this, BddDslPackage.LIST_VALUE__VALUES);
    }
    return values;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BddDslPackage.LIST_VALUE__VALUES:
