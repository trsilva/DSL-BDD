 ...
 *   <li>{@link no.hal.bdd.bddDsl.ActionRef#getEntity <em>Entity</em>}</li>
 * </ul>
 *
...
public interface ActionRef extends EObject
{
   ...
   * @see no.hal.bdd.bddDsl.BddDslPackage#getActionRef_Entity()
   * @model containment="true"
   * @generated
   */
  EntityDef getEntity();
  ...
  /**
   * Sets the value of the '{@link no.hal.bdd.bddDsl.ActionRef#getEntity <em>Entity</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
